...
class VisibleEvaluator(DatasetEvaluator):
    """
    ...
    def _eval_predictions(self, predictions, img_ids=None):
        ...
        if hasattr(self._metadata, "thing_dataset_id_to_contiguous_id"):
            ...
            print(all_contiguous_ids, max(all_contiguous_ids), num_classes)
        ...
        coco_api = copy.deepcopy(self._coco_api)
        for key, ann in coco_api.anns.items():
            coco_api.anns[key]["segmentation"] = coco_api.anns[key]["visible_mask"]
